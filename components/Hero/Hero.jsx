      ...
      <section className="grid mx-auto  px-4  sm:px-6 lg:px-8 max-w-full">
        <div className="grid mx-auto max-w-screen-xl px-4 py-8  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <a
              href="#whyCD"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center border border-black-300 rounded-lg text-white border-gray-700 bg-black mt-2"
            >
              Learn More 
            </a>
          </div>
