        ...
        <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
          <div className="grid grid-cols-1 sm:grid-cols-3 text-center divide-y sm:divide-y-0 sm:divide-x">
            <dl className="space-y-1 p-5">
              <dt className="text-4xl font-extrabold">8,600+</dt>
              <dd className="text-sm uppercase tracking-wide font-semibold text-purple-600">
            ...
            <dl className="space-y-1 p-5">
              <dt className="text-4xl font-extrabold">760k+</dt>
              <dd className="text-sm uppercase tracking-wide font-semibold text-purple-600">
